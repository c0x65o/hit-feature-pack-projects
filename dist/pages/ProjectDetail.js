...
export function ProjectDetail(props) {
    ...
    const handleUpdateActivity = async () => {
        if (!editingActivity || !formTypeId || !formTitle.trim())
            return;
        ...
        try {
            ...
            await alertDialog.showAlert(err instanceof Error ? err.message : 'Failed to update activity', {
                variant: 'error',
                title: 'Error',
            });
        }
    ...
    const handleDeleteActivity = async (activity) => {
        ...
        try {
            ...
            await alertDialog.showAlert(err instanceof Error ? err.message : 'Failed to delete activity', {
                variant: 'error',
                title: 'Error',
            });
        }
